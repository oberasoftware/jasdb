...
import com.oberasoftware.jasdb.api.index.*;
import com.oberasoftware.jasdb.core.concurrency.ResourceLockManager;
import com.oberasoftware.jasdb.core.index.*;
...
import com.oberasoftware.jasdb.core.index.btreeplus.search.EqualsSearchOperation;
import com.oberasoftware.jasdb.core.index.btreeplus.search.NotEqualsSearchOperation;
import com.oberasoftware.jasdb.core.index.btreeplus.search.RangeSearchOperation;
import com.oberasoftware.jasdb.core.index.btreeplus.search.SearchOperation;
...
public class BTreeIndex implements Index {
    ...
    RootBlock getRootBlock() throws JasDBStorageException {
        openIndex();
        return rootBlock;
    }
    ...
    public IndexScanReport scan(ScanIntent intent, Iterator<IndexableItem> indexableItems) throws JasDBStorageException {
        try {
            ...
            scanReport = new IndexScanReportImpl(IndexState.INVALID, System.currentTimeMillis(), 0);
            return scanReport;
        }
    }
    ...
    private void resetIndex() throws JasDBStorageException {
