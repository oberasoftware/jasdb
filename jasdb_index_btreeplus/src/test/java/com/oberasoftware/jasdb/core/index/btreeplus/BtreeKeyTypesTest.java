...
public class BtreeKeyTypesTest extends IndexBaseTest {
    ...
    public void testIndexUnicodeStringKey() throws Exception {
        KeyInfo keyInfo = new KeyInfoImpl(new SimpleIndexField("string", new StringKeyType(4)), new SimpleIndexField(RECORD_POINTER, new LongKeyType()));
    ...
    public void testStringKeyLongIndex() throws Exception {
        KeyInfo keyInfo = new KeyInfoImpl(new SimpleIndexField("long", new LongKeyType()), new SimpleIndexField(RECORD_POINTER, new LongKeyType()));
    ...
    public void testLongKeyStringIndex() throws Exception {
        KeyInfo keyInfo = new KeyInfoImpl(new SimpleIndexField("string", new StringKeyType()), new SimpleIndexField(RECORD_POINTER, new LongKeyType()));
        BTreeIndex index = new BTreeIndex(new File(tmpDir, "indexbag_string.idx"), keyInfo);
