...
public interface Index extends AutoCloseable {
	 ...
	 * @throws JasDBStorageException If unable to complete the search in the index
	 */
	 ...
	 * @throws JasDBStorageException If unable to persist the key in the index
	 */
	 ...
	 * @throws JasDBStorageException If unable to remove the key from the index
	 */
     ...
     * @throws JasDBStorageException If unable to perform or complete index scan
     */
	 ...
	 * @throws JasDBStorageException If unable to rebuild the index
	 */
