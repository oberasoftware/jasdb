...
import static com.oberasoftware.jasdb.core.utils.conversion.LongUtils.bytesToLong;
import static com.oberasoftware.jasdb.core.utils.conversion.LongUtils.longToBytes;
...
public class LongKey extends AbstractKey {
    ...
    @Override
    public long size() {
        return MemoryConstants.LONG_BYTE_SIZE + super.size();
    }
