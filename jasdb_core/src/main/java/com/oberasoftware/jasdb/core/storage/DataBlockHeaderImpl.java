...
public class DataBlockHeaderImpl implements DataBlockHeader {
     ...
     */
    private static final int BLOCK_MANDATORY_HEADER = MemoryConstants.TWO_LONG_BYTES + MemoryConstants.LONG_BYTE_SIZE + MemoryConstants.INTEGER_BYTE_SIZE;

    public static final int PREVIOUS_INDEX = 0; //start of the block
    public static final int NEXT_INDEX = MemoryConstants.LONG_BYTE_SIZE; //after the 'previous' long
    public static final int NEXTSTREAM_INDEX = MemoryConstants.TWO_LONG_BYTES; //location of next datastream (optional)
    public static final int MARKER_INDEX = MemoryConstants.TWO_LONG_BYTES + MemoryConstants.LONG_BYTE_SIZE; //after the 'previous', 'next' and 'next stream' longs
