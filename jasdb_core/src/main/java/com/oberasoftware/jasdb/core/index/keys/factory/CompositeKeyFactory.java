...
import com.oberasoftware.jasdb.api.index.keys.*;
...
import com.oberasoftware.jasdb.core.index.keys.types.ComplexKeyType;
...
public class CompositeKeyFactory implements KeyFactory {
    ...
    public KeyLoadResult loadKey(int offset, DataBlock dataBlock) throws JasDBStorageException {
        ...
        return new KeyLoadResultImpl(result.getLoadedKey(), result.getEndBlock(), result.getNextOffset());
    }
