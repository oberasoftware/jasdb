...
public interface RecordWriter {
	 ...
	 */
	void writeRecord(UUIDKey documentId, ClonableDataStream dataStream) throws JasDBStorageException;
	 ...
	 */
	void removeRecord(UUIDKey documentId) throws JasDBStorageException;
	 ...
	 */
	void updateRecord(UUIDKey documentId, ClonableDataStream dataStream) throws JasDBStorageException;
}