...
public class SimpleEntityTest {
    ...
    public void testSerializeDeserialize() throws MetadataParseException {
        ...
        Entity deserializedEntity = SimpleEntity.fromJson(serializedEntity);
    ...
    public void testEmbeddedEntity() throws MetadataParseException {
        ...
        assertThat(deserializedEntity.getValues("embedded.embeddedMultivalue").size(), is(3));
        assertThat(deserializedEntity.getValue("embedded.embeddedString"), is("simpleStringValue"));
    ...
    public void deserializeEmbeddedEntity() throws MetadataParseException {
        ...
        Entity entity = SimpleEntity.fromJson(entityString);
    ...
    public void testSetBulkProperties() {
        ...
        calendar.set(2013, Calendar.FEBRUARY, 31, 0, 0, 0);
    ...
    public void testRetainArray() throws JsonProcessingException, MetadataParseException {
        ...
        Person person = new Person("Person Test", Collections.singletonList("12345678"));

        String json = objectMapper.writeValueAsString(person);
        Entity simpleEntity = SimpleEntity.fromJson(json);
    ...
    private void assertEntity(Entity entity) {
        ...
        assertThat(entity.getProperty("test1").getValues(), hasItems(new StringValue("value1"), new StringValue("value2")));
        assertThat(entity.getProperty("test2").getValues(), hasItems((Value) new StringValue("someValue")));
        assertThat(entity.getProperty("test3").getValues(), hasItems(new LongValue(1L), new LongValue(2L)));
